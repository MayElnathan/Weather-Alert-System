...
const AlertsPage = () => {
  ...
  const updateAlertMutation = useMutation({
    ...
    onError: (error) => {
      toast.error(`Failed to update alert: ${error instanceof Error ? error.message : 'Unknown error'}`);
    },
  });
  ...
  const deleteAlertMutation = useMutation({
    ...
    onError: (error) => {
      toast.error(`Failed to delete alert: ${error instanceof Error ? error.message : 'Unknown error'}`);
    },
  });
